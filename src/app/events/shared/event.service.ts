...
export class EventService {
  ...
  searchSessions(searchValue: string){
    var value = searchValue.toLocaleLowerCase(); 
    var results: ISession[] = [];

    EVENTS.forEach(events => {
      var matchingSessions: ISession[] = events.sessions.filter(session =>
...
const EVENTS:IEvent[] = [
  ...
  },
  {
    ...
    //   country: "Netherlands"
    // },
    onlineUrl: "www.friendbirthday.mi",
    sessions: [
      {
        id: 1,
      ...
      },
      {
        ...
        abstract: `In this session, Lukas will present the 
          ...
          showing how you*ngSwitchCase="'8:00 am'" too can be success with just attitude.`,
        voters: ["bradgreen"]
      }
    ]
  },
